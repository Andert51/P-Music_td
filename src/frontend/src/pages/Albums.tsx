...
export const Albums: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h1 className="text-5xl font-bold text-white mb-2">Albums</h1>
      ...
      {albums.length === 0 ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          {albums.map((album, index) => (
            ...
            >
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gradient-to-br from-primary/20 to-purple-500/20 mb-4 shadow-lg">
                {album.cover_image ? (
                  <img
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="bg-primary rounded-full p-4 shadow-xl"
                  >
              ...
              <div className="space-y-1">
                <h3 className="font-semibold text-white truncate group-hover:text-primary transition">
                  {album.title}
                </h3>
                {album.release_date && (
                ...
                <p className="text-sm text-gray-500 truncate">{album.description || 'Album'}</p>
              </div>
            </motion.div>
          ))}
        </div>
